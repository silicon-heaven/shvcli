...
- interpretation of SHV type hints and inclusion of `IS_UPDATABLE` flag in
  method parameter validation


## [0.8.1] - 2025-11-26
### Fixed
- file copy failure if node didn't provide truncate method
...
### Changed
- Minimal supported version of pySHV is now 0.10.0
...
[unreleased]: https://gitlab.com/silicon-heaven/shvcli/compare/v0.8.1..HEAD
[0.8.1]: https://gitlab.com/silicon-heaven/shvcli/compare/v0.8.0..v0.8.1
[0.8.0]: https://gitlab.com/silicon-heaven/shvcli/compare/v0.7.0..v0.8.0
